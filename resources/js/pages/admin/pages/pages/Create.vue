            ...
            >
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="space-y-1.5">
                            ...
                            <p v-if="form.errors.type" class="text-xs text-rose-600">{{ form.errors.type }}</p>
                        </div>
                ...
                <section class="space-y-4">
                    <div>
                        ...
                        <div class="text-xs text-muted-foreground">Dodaj nove slike (upload).</div>
                    </div>
