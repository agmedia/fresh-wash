...
const submit = () => {
    form.put(`/admin/catalog/services/${props.service.id}`, { preserveScroll: true });
};

const showHref = computed(() => `/admin/catalog/services/${props.service.id}`);
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input
                                ...
                                class="w-full rounded border border-input bg-background px-3 py-2 text-sm text-foreground
                                       placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring/40"
                                placeholder="npr. Najam ormarića 24h"
                            />
