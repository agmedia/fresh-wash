        ...
        <form @submit.prevent="submit" class="max-w-3xl space-y-6">
            <div class="grid gap-4 md:grid-cols-2">
                <div class="space-y-2">
                    ...
                    <input v-model="form.first_name" type="text" class="w-full rounded border px-3 py-2 text-sm" />
                ...
                <div class="space-y-2">
                    ...
                    <input v-model="form.last_name" type="text" class="w-full rounded border px-3 py-2 text-sm" />
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="space-y-2">
                    ...
                    <div v-if="form.errors.address_line1" class="text-sm text-red-600">{{ form.errors.address_line1 }}</div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div v-if="form.errors.address_line2" class="text-sm text-red-600">{{ form.errors.address_line2 }}</div>
                </div>
            </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="space-y-2">
                    ...
                    <input v-model="form.country_code" maxlength="2" type="text" class="w-full rounded border px-3 py-2 text-sm" />
                    <div v-if="form.errors.country_code" class="text-sm text-red-600">{{ form.errors.country_code }}</div>
                </div>

                <div class="space-y-2">
                    <label class="block text-sm font-medium">Telefon</label>
                    <input v-model="form.phone" type="text" class="w-full rounded border px-3 py-2 text-sm" />
                    <div v-if="form.errors.phone" class="text-sm text-red-600">{{ form.errors.phone }}</div>
                </div>
            </div>

            <div class="flex items-center gap-2">
                <input id="wa" v-model="form.whatsapp_opt_in" type="checkbox" class="h-4 w-4" />
                <label for="wa" class="text-sm">WhatsApp opt-in</label>
                <div v-if="form.errors.whatsapp_opt_in" class="text-sm text-red-600">{{ form.errors.whatsapp_opt_in }}</div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <a href="/admin/users" class="text-sm text-blue-600">Natrag</a>
            </div>
        </form>
    </AdminLayout>
</template>